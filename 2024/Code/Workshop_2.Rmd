...
2.  For small projects, it is good practice to keep your data in the
    same folder as your code, so we recommending moving it there. (For
    larger projects with many data files, you may want to keep code and
    data in separate subfolders)
