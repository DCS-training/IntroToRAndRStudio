...
x + y # sum the variable x and the variable y
...
rm (list = ls()) # Remove all variables in current project. This very simple code uses multiple functions and arguments.
...
Led_Zeppelin <- select(df5, 1,6,2,3,4,5)
Led_Zeppelin
